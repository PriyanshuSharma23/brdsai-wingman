    ...
    <>
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="overview">
          <div className="px-4 md:px-16 py-5 border-b">
        ...
        <TabsContent value="transcript">
          <div className="px-4 space-y-2 md:space-y-4 sticky  bg-white text-neutral-600 py-4 md:px-16 top-[6.2rem] -mt-2 -translate-y-[2px]">
            <SearchIconInput
          ...
          <div className="space-y-4 pt-2 pb-6 flex-1 text-neutral-500 px-4 md:px-16">
            ...
            {transcriptQuery.data?.segments?.map((transcriptSegment, i) => (
              <>
                <TranscriptSegment
      ...
      <div className="w-full bg-white py-5 fixed bottom-0 inset-x-0 border-t ">
        <div className="pb-5 w-full bg-white px-4 gap-2 grid place-content-stretch container">
          <Button
